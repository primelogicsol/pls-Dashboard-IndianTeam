...
export default function ModeratorProjectStatusPage() {
  const { isAuthorized } = useAuth(["ADMIN", "MODERATOR"]);
  const router = useRouter();

  // State hooks (must always be called before conditional rendering)
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold">Existing Project</h1>
        <Button onClick={() => router.push("/dashboard/Administrator/project-status/create-project")}>
      ...
      {Pageloading ? (
        ...
        <Card className="p-8 text-center">
          <CardContent>
            ...
            <Button
              onClick={() => router.push("/dashboard/client/projects/create-project")}
            >
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="mt-4 flex justify-center gap-2">
                          ...
                          <Button
                            onClick={() =>
                              router.push(
                                `/dashboard/Administrator/project-status/${project.projectSlug}`
                              )
                            }
                            variant="outline"
                          >
          ...
          {selectedProject && (
            <>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-sm">Assigned Freelancers</h4>
